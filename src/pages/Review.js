	...
	return (
		<div className='h-full relative p-[54px] font-alfa flex flex-col gap-[20px] '>
			...
			<div className='w-full flex justify-center'>
				<div className='h-[161px] w-[500px] rounded-[20px] flex  text-white p-5 cursor-pointer bg-chocolate border-solid border-4 border-white'>
					{answer[index + 1]
						? `${answer[index + 1]} . ${
			...
			<div className='flex items-center justify-center gap-2 text-red-600 text-[64px]'>
			...
			<div className='text-center text-blue text-[20px]'>
			...
			<div className='absolute bottom-[60px] right-[54px] flex justify-end mx-[20px] mt-5 gap-5 '>
				...
				<div
					...
					className='text-[36px] bg-chocolate flex items-center p-1 text-blue border-[6px] border-blue hover:scale-110 hover:text-white hover:border-white'>
					View Score
				</div>
			</div>
		</div>
