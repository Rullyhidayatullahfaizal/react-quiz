...
export const Footer = ({ display, handleStart }) => {
  return (
    <div className="bg-[#435B66] w-full flex justify-between items-center px-[73px] py-[9px] text-blue font-aclonica">
      <div className="flex gap-[24px]">
        <svg
          className="bg-navy border-[6px] border-chocolate rounded-full fill-chocolate hover:border-white hover:scale-110 hover:shadow-2xl hover:fill-white"
      ...
      <div className="text-[24px] font-alfa">created by: Rully H-F</div>
    </div>
  );
};
